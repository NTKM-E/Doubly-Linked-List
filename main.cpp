...
bool testInsertFirst() {
    ...
    exampleList.insertFirst(2);
    exampleList.insertFirst(1);
    assert(exampleList.length() == 3);
    cout << "Forward Print Expected Output: 1 2 3" << endl;
    exampleList.print(true);
    cout << "Reverse Print Expected Output: 3 2 1" << endl;
...
bool testInsertLast() {
    ...
    exampleList.insertLast(8);
    exampleList.insertLast(9);
    assert(exampleList.search(9));
    cout << "Forward Print Expected Output: 7 8 9" << endl;
    exampleList.print(true);
    cout << "Reverse Print Expected Output: 9 8 7" << endl;
    exampleList.print(false);
    exampleList.destroyList();
    return true;
}
